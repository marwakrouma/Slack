...
class ServiceIntegration(PluginBase):
    ...
    def post_receive(self, alert):
        ...
        SLACK_WEBHOOK_URL_LIST= ['webhook URL 1',
                                 'webhook URL 2']
        ALERTA_CUSTOMERS_LIST= ['channel1','channel2']
        INDEX_CUSTOMER=ALERTA_CUSTOMERS_LIST.index(alert.customer)

        try:
            r = requests.post(SLACK_WEBHOOK_URL_LIST[INDEX_CUSTOMER],
